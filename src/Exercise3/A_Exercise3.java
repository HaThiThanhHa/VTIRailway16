...
public class A_Exercise3 {
	...
	public static void main(String[] args) {
		...
		acc1.position			 		= pos1;
		acc1.createDate					= new Date(2020-1900,12,9);
		...
		acc2.position 					= pos2;
		acc2.createDate 				= new Date(2019-1900,05,07);
		...
		acc3.position		 			= pos3;
		acc3.createDate 				= new Date(2019-1900,05,17);
		 ...
		 ga1.group			 	= group1 ;
		 ga1.account			= acc1;
		 ga1.joinDate 			= new Date (2018-1900,11,25);
	
		 GroupAccount  ga2 		= new GroupAccount ();
		 ga2.group				= group2;
		 ga2.account			= acc2;
		 ga2.joinDate 			= new Date (2018-1900,3,9);
	
		GroupAccount  ga3		= new GroupAccount ();
		ga3.group 				= group3;
		ga3.account				= acc3;
		ga3.joinDate 			= new Date (2019-1900,6,2);		
		...
		q1.account											= acc1;
		q1.createDate										= new Date (2018-1900,11,04);
		...
		q2.account											= acc2;
		q2.createDate										= new Date (2017-1900,06,25);		
		...
		q3.account											= acc3;
		q3.createDate										= new Date (2018-1900,04,06);
		...
		ex1.account				= acc1;
		ex1.createDate 			= new Date (2018-1900,8,5);
		...
		ex2.account				= acc2;
		ex2.createDate 			= new Date (2018-1900,8,25);
		...
		ex3.account				= acc3;
		ex3.createDate 			= new Date (2018-1900,10,24);
...
//		 In ra thông tin Exam thứ 1 và property create date sẽ được format theo định dạng vietnamese
		...
		System.out.println("	 In ra thông tin Exam thứ 1 và property create date sẽ được format theo định dạng vietnamese");
...
//		 In ra thông tin: Exam đã tạo ngày nào theo định dạng  Năm – tháng – ngày – giờ – phút – giây
			...
			System.out.println("	 In ra thông tin: Exam đã tạo ngày nào theo định dạng  Năm – tháng – ngày – giờ – phút – giây");
...
//		 Chỉ in ra năm của create date property trong Question 2
		 ...
		 date = simpleDateFormat.format(exam1.createDate);
...
//		 Chỉ in ra tháng và năm của create date property trong Question 2
		 ...
		 date = simpleDateFormat.format(exam2.createDate);
		 System.out.println(exam2.code + ": " + date);
		 }
...
//		 Chỉ in ra "MM-DD" của create date trong Question 2
		 ...
		 for (Exam exam3 : exams) {
		 date = simpleDateFormat.format(exam3.createDate);

		 System.out.println(exam3.code + ": " + date);
		 }
		 }
	}
}